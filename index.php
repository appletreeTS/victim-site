...
<div class="services">
  <div class="card">
    <div class="icon">🏦</div>
    <h3>인터넷뱅킹</h3>
    <p>언제 어디서나 편리하게 금융 서비스를 이용하세요</p>
    <a href="login.php">로그인</a>
  </div>
  <div class="card">
    <div class="icon">🔍</div>
    <h3>계좌조회</h3>
    <p>잔액 및 거래내역을 실시간으로 확인하세요</p>
    <a href="search.php">조회하기</a>
  </div>
  <div class="card">
    <div class="icon">💬</div>
    <h3>고객센터</h3>
    <p>궁금한 점을 문의하고 답변을 받아보세요</p>
    <a href="xss.php">문의하기</a>
  </div>
  <div class="card">
    <div class="icon">📄</div>
    <h3>서류제출</h3>
    <p>대출 및 계좌 개설 서류를 온라인으로 제출하세요</p>
    <a href="upload.php">제출하기</a>
  </div>
  <div class="card">
    <div class="icon">🌐</div>
    <h3>네트워크진단</h3>
    <p>인터넷뱅킹 연결 상태를 진단하세요</p>
    <a href="cmd.php">진단하기</a>
  </div>
</div>
